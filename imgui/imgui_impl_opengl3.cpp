...
static char         g_GlslVersionString[32] = "";   // Specified by user or detected based on compile t GL settings.
...
void    ImGui_ImplOpenGL3_RenderDrawData(ImDrawData* draw_data)
{
    ...
    // Recreate the VAO every t (this is to easily allow multiple GL contexts to be rendered to. VAO are not shared among GL contexts)
