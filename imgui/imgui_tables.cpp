...
//    | TableBeginInitMemory()                  - first t table is used
...
void ImGui::TableUpdateLayout(ImGuiTable* table)
{
    ...
    // FIXME-TABLE: for always auto-resizing columns may not want to do that all the t.
...
// Process valid-testing on resizing borders. Actual size change will be applied in EndTable()
...
void ImGui::TableSetBgColor(ImGuiTableBgTarget target, ImU32 color, int column_n)
{
    ...
    // We cannot draw neither the cell or row background immediately as we don't know the row height at this point in t.
    switch (target)
    {
